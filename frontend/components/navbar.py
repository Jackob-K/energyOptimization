...
def navbar() -> rx.Component:
    return rx.el.nav(
        rx.hstack(
            ...
            rx.spacer(),  # Můžeme použít spacer pro vyplnění prostoru
            menu_button(),  # Tlačítka menu
            align="center",
            width="100%",
            padding_y="0.75em",  # Zmenšíme padding
            padding_x="1em",  # Zajistíme menší padding pro lepší zarovnání
